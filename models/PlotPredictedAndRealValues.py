...
def plot_predicted_and_real_values(y_test, y_prediction, date):
    ...
    plt.title('PM10 level (real and predicted) in Cracow from 2000 to 2021 using simple recurrent neural network '
              'regression')
    plt.show()